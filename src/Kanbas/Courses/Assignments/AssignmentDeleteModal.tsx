...
{ assignmentId: string; deleteAssignment: (assignmentId: string) => void }) {
    useEffect(() => {
        console.log("Received ID in modal:", newAssignmentId);
    })
    const {newAssignmentId} = useSelector((state: any) => state.deleteAssignmentReducer)
    return (
            ...
            <div className="modal-dialog">
                <div className="modal-content">
                    ...
                    <div className="modal-footer">
                        ...
                        <button type="button" className="btn btn-danger" onClick={() => deleteAssignment(newAssignmentId)} data-bs-dismiss="modal">Yes</button>
                    </div>
                </div>
            </div>
        </div>
