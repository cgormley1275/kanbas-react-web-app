...
export default function WorkingWithArrays() {
    ...
    return (
        <div id="wd-working-with-arrays">
            ...
            <h3>Updating an Item's Description'</h3>
            ...
            <h3>Updating an Item's Status'</h3>
            ...
            <input type="checkbox" checked={todo.completed} id="completed" className="m-2" onChange={(e) => setTodo({...todo, completed: !todo.completed})}/>
            <br /><br /><hr />
        </div>
    );
}
